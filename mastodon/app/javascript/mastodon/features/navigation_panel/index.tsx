...
const messages = defineMessages({
  ...
  personalCalendar: {
    id: 'navigation_bar.personal_calendar',
    defaultMessage: 'My calendar',
  },
  exploreCalendar: {
    id: 'navigation_bar.explore_calendar',
    defaultMessage: 'Explore Calendar',
  },
  notifications: {
...
const CALENDAR_BASE_URL = 'https://calendar.time-grid.org';

const buildPersonalCalendarUrl = (username?: string | null) =>
  username ? `${CALENDAR_BASE_URL}/u/${encodeURIComponent(username)}` : CALENDAR_BASE_URL;
...
export const NavigationPanel: React.FC<{ multiColumn?: boolean }> = ({
  ...
  const username = useAppSelector((state) =>
    me ? state.accounts.getIn([me, 'username']) as string | undefined : undefined,
  );
  const personalCalendarUrl = buildPersonalCalendarUrl(username);
  ...
  return (
    <div className='navigation-panel'>
      <div className='navigation-panel__logo'>
        ...
        <a
          href={CALENDAR_BASE_URL}
          className='navigation-panel__calendar-home'
          target='_blank'
          rel='noopener'
          aria-label='Open TimeGrid calendar in a new tab'
          title='Open TimeGrid calendar'
        >
          <span className='navigation-panel__calendar-home-badge'>TG</span>
        </a>
      </div>
      ...
      <div className='navigation-panel__menu'>
        ...
        {signedIn && (
          <>
            ...
            <a
              href={`${CALENDAR_BASE_URL}/published`}
              className='column-link column-link--transparent navigation-panel__calendar-link'
              target='_self'
            >
              <span className='navigation-panel__calendar-link-mark'>TG</span>
              <span>{intl.formatMessage(messages.exploreCalendar)}</span>
            </a>
            ...
            <a
              href={personalCalendarUrl}
              className='column-link column-link--transparent navigation-panel__calendar-link'
              target='_self'
            >
              <span className='navigation-panel__calendar-link-mark'>TG</span>
              <span>{intl.formatMessage(messages.personalCalendar)}</span>
            </a>

var TimeGridScheduleXCalendar = (() => {
  ...
  // src/readonly.js
  var readonly_exports = {};
  __export(readonly_exports, {
    destroy: () => destroy,
  ...
  function nudgeRelativeDuration(e5, n4, t5, o5, r5, i5, a5, s5, c5, u6) {
    const f6 = computeDurationSign(e5), l6 = p[o5], d6 = gr(o5, e5);
    7 === o5 && (e5 = {
      ...e5,
  ...
  function k2(l6, u6, t5) {
    ...
    return x2(l6, e5, i5, r5, null);
  }
  function x2(n4, t5, i5, r5, o5) {
    var e5 = { type: n4, props: t5, key: i5, ref: r5, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o5 ? ++u2 : o5, __i: -1, __u: 0 };
  ...
  function $2(n4, l6) {
    if (null == l6) return n4.__ ? $2(n4.__, n4.__i + 1) : null;
    for (var u6; l6 < n4.__k.length; l6++) if (null != (u6 = n4.__k[l6]) && null != u6.__e) return u6.__e;
    return "function" == typeof n4.type ? $2(n4) : null;
  }
  function I2(n4) {
    if (n4.__P && n4.__d) {
      var u6 = n4.__v, t5 = u6.__e, i5 = [], r5 = [], o5 = m2({}, u6);
      o5.__v = u6.__v + 1, l2.vnode && l2.vnode(o5), q2(n4.__P, o5, u6, n4.__n, n4.__P.namespaceURI, 32 & u6.__u ? [t5] : null, i5, null == t5 ? $2(u6) : t5, !!(32 & u6.__u), r5), o5.__v = u6.__v, o5.__.__k[o5.__i] = o5, D2(i5, o5, r5), u6.__e = u6.__ = null, o5.__e != t5 && P2(o5);
    }
  }
  function P2(n4) {
  ...
  function L2(n4, l6, u6, t5, i5, r5, o5, e5, f6, c5, s5) {
    var a5, h6, p6, v5, y6, _6, g7, m6 = t5 && t5.__k || w2, b5 = l6.length;
    for (f6 = T2(u6, l6, m6, f6, b5), a5 = 0; a5 < b5; a5++) null != (p6 = u6.__k[a5]) && (h6 = -1 != p6.__i && m6[p6.__i] || d2, p6.__i = a5, _6 = q2(n4, p6, h6, i5, r5, o5, e5, f6, c5, s5), v5 = p6.__e, p6.ref && h6.ref != p6.ref && (h6.ref && J2(h6.ref, null, p6), s5.push(p6.ref, p6.__c || v5, p6)), null == y6 && null != v5 && (y6 = v5), (g7 = !!(4 & p6.__u)) || h6.__k === p6.__k ? (f6 = j2(p6, f6, n4, g7), g7 && h6.__e && (h6.__e = null)) : "function" == typeof p6.type && void 0 !== _6 ? f6 = _6 : v5 && (f6 = v5.nextSibling), p6.__u &= -7);
    return u6.__e = y6, f6;
  }
  function T2(n4, l6, u6, t5, i5) {
    var r5, o5, e5, f6, c5, s5 = u6.length, a5 = s5, h6 = 0;
    for (n4.__k = new Array(i5), r5 = 0; r5 < i5; r5++) null != (o5 = l6[r5]) && "boolean" != typeof o5 && "function" != typeof o5 ? ("string" == typeof o5 || "number" == typeof o5 || "bigint" == typeof o5 || o5.constructor == String ? o5 = n4.__k[r5] = x2(null, o5, null, null, null) : g2(o5) ? o5 = n4.__k[r5] = x2(S2, { children: o5 }, null, null, null) : void 0 === o5.constructor && o5.__b > 0 ? o5 = n4.__k[r5] = x2(o5.type, o5.props, o5.key, o5.ref ? o5.ref : null, o5.__v) : n4.__k[r5] = o5, f6 = r5 + h6, o5.__ = n4, o5.__b = n4.__b + 1, e5 = null, -1 != (c5 = o5.__i = O2(o5, u6, f6, a5)) && (a5--, (e5 = u6[c5]) && (e5.__u |= 2)), null == e5 || null == e5.__v ? (-1 == c5 && (i5 > s5 ? h6-- : i5 < s5 && h6++), "function" != typeof o5.type && (o5.__u |= 4)) : c5 != f6 && (c5 == f6 - 1 ? h6-- : c5 == f6 + 1 ? h6++ : (c5 > f6 ? h6-- : h6++, o5.__u |= 4))) : n4.__k[r5] = null;
    if (a5) for (r5 = 0; r5 < s5; r5++) null != (e5 = u6[r5]) && 0 == (2 & e5.__u) && (e5.__e == t5 && (t5 = $2(e5)), K2(e5, e5));
    return t5;
  }
  function j2(n4, l6, u6, t5) {
    var i5, r5;
    if ("function" == typeof n4.type) {
      for (i5 = n4.__k, r5 = 0; i5 && r5 < i5.length; r5++) i5[r5] && (i5[r5].__ = n4, l6 = j2(i5[r5], l6, u6, t5));
      return l6;
    }
    n4.__e != l6 && (t5 && (l6 && n4.type && !l6.parentNode && (l6 = $2(n4)), u6.insertBefore(n4.__e, l6 || null)), l6 = n4.__e);
    do {
  ...
  function F2(n4, l6) {
    return l6 = l6 || [], null == n4 || "boolean" == typeof n4 || (g2(n4) ? n4.some(function(n5) {
      F2(n5, l6);
    }) : l6.push(n4)), l6;
  }
  function O2(n4, l6, u6, t5) {
    var i5, r5, o5, e5 = n4.key, f6 = n4.type, c5 = l6[u6], s5 = null != c5 && 0 == (2 & c5.__u);
  ...
  function z2(n4, l6, u6) {
    "-" == l6[0] ? n4.setProperty(l6, null == u6 ? "" : u6) : n4[l6] = null == u6 ? "" : "number" != typeof u6 || _2.test(l6) ? u6 : u6 + "px";
  }
  function N2(n4, l6, u6, t5, i5) {
    ...
    else if ("o" == l6[0] && "n" == l6[1]) r5 = l6 != (l6 = l6.replace(a2, "$1")), o5 = l6.toLowerCase(), l6 = o5 in n4 || "onFocusOut" == l6 || "onFocusIn" == l6 ? o5.slice(2) : l6.slice(2), n4.l || (n4.l = {}), n4.l[l6 + r5] = u6, u6 ? t5 ? u6[s2] = t5[s2] : (u6[s2] = h2, n4.addEventListener(l6, r5 ? v2 : p2, r5)) : n4.removeEventListener(l6, r5 ? v2 : p2, r5);
    else {
  ...
  function V2(n4) {
    return function(u6) {
      if (this.l) {
        ...
        if (null == u6[c2]) u6[c2] = h2++;
        else if (u6[c2] < t5[s2]) return;
        return t5(l2.event ? l2.event(u6) : u6);
      }
    };
  }
  function q2(n4, u6, t5, i5, r5, o5, e5, f6, c5, s5) {
    var a5, h6, p6, v5, y6, d6, _6, k5, x6, M4, $4, I3, P5, A6, H4, T7 = u6.type;
    if (void 0 !== u6.constructor) return null;
    128 & t5.__u && (c5 = !!(32 & t5.__u), o5 = [f6 = u6.__e = t5.__e]), (a5 = l2.__b) && a5(u6);
    n: if ("function" == typeof T7) try {
      if (k5 = u6.props, x6 = T7.prototype && T7.prototype.render, M4 = (a5 = T7.contextType) && i5[a5.__c], $4 = a5 ? M4 ? M4.props.value : a5.__ : i5, t5.__c ? _6 = (h6 = u6.__c = t5.__c).__ = h6.__E : (x6 ? u6.__c = h6 = new T7(k5, $4) : (u6.__c = h6 = new C2(k5, $4), h6.constructor = T7, h6.render = Q2), M4 && M4.sub(h6), h6.state || (h6.state = {}), h6.__n = i5, p6 = h6.__d = true, h6.__h = [], h6._sb = []), x6 && null == h6.__s && (h6.__s = h6.state), x6 && null != T7.getDerivedStateFromProps && (h6.__s == h6.state && (h6.__s = m2({}, h6.__s)), m2(h6.__s, T7.getDerivedStateFromProps(k5, h6.__s))), v5 = h6.props, y6 = h6.state, h6.__v = u6, p6) x6 && null == T7.getDerivedStateFromProps && null != h6.componentWillMount && h6.componentWillMount(), x6 && null != h6.componentDidMount && h6.__h.push(h6.componentDidMount);
      else {
        if (x6 && null == T7.getDerivedStateFromProps && k5 !== v5 && null != h6.componentWillReceiveProps && h6.componentWillReceiveProps(k5, $4), u6.__v == t5.__v || !h6.__e && null != h6.shouldComponentUpdate && false === h6.shouldComponentUpdate(k5, h6.__s, $4)) {
          u6.__v != t5.__v && (h6.props = k5, h6.state = h6.__s, h6.__d = false), u6.__e = t5.__e, u6.__k = t5.__k, u6.__k.some(function(n5) {
            n5 && (n5.__ = u6);
          }), w2.push.apply(h6.__h, h6._sb), h6._sb = [], h6.__h.length && e5.push(h6);
          break n;
        }
      ...
      if (h6.context = $4, h6.props = k5, h6.__P = n4, h6.__e = false, I3 = l2.__r, P5 = 0, x6) h6.state = h6.__s, h6.__d = false, I3 && I3(u6), a5 = h6.render(h6.props, h6.state, h6.context), w2.push.apply(h6.__h, h6._sb), h6._sb = [];
      else do {
        h6.__d = false, I3 && I3(u6), a5 = h6.render(h6.props, h6.state, h6.context), h6.state = h6.__s;
      } while (h6.__d && ++P5 < 25);
      h6.state = h6.__s, null != h6.getChildContext && (i5 = m2(m2({}, i5), h6.getChildContext())), x6 && !p6 && null != h6.getSnapshotBeforeUpdate && (d6 = h6.getSnapshotBeforeUpdate(v5, y6)), A6 = null != a5 && a5.type === S2 && null == a5.key ? E2(a5.props.children) : a5, f6 = L2(n4, g2(A6) ? A6 : [A6], u6, t5, i5, r5, o5, e5, f6, c5, s5), h6.base = u6.__e, u6.__u &= -161, h6.__h.length && e5.push(h6), _6 && (h6.__E = h6.__ = null);
    } catch (n5) {
      if (u6.__v = null, c5 || null != o5) if (n5.then) {
        ...
        for (H4 = o5.length; H4--; ) b2(o5[H4]);
        B2(u6);
      }
      else u6.__e = t5.__e, u6.__k = t5.__k, n5.then || B2(u6);
      l2.__e(n5, u6, t5);
    }
    else null == o5 && u6.__v == t5.__v ? (u6.__k = t5.__k, u6.__e = t5.__e) : f6 = u6.__e = G2(t5.__e, u6, t5, i5, r5, o5, e5, c5, s5);
  ...
  function D2(n4, u6, t5) {
    for (var i5 = 0; i5 < t5.length; i5++) J2(t5[i5], t5[++i5], t5[++i5]);
  ...
  function E2(n4) {
    return "object" != typeof n4 || null == n4 || n4.__b > 0 ? n4 : g2(n4) ? n4.map(E2) : m2({}, n4);
  }
  function G2(u6, t5, i5, r5, o5, e5, f6, c5, s5) {
    var a5, h6, p6, v5, y6, w6, _6, m6 = i5.props || d2, k5 = t5.props, x6 = t5.type;
    if ("svg" == x6 ? o5 = "http://www.w3.org/2000/svg" : "math" == x6 ? o5 = "http://www.w3.org/1998/Math/MathML" : o5 || (o5 = "http://www.w3.org/1999/xhtml"), null != e5) {
      for (a5 = 0; a5 < e5.length; a5++) if ((y6 = e5[a5]) && "setAttribute" in y6 == !!x6 && (x6 ? y6.localName == x6 : 3 == y6.nodeType)) {
        u6 = y6, e5[a5] = null;
        break;
      }
    }
    if (null == u6) {
      ...
      u6 = document.createElementNS(o5, x6, k5.is && k5), c5 && (l2.__m && l2.__m(t5, e5), c5 = false), e5 = null;
    }
    if (null == x6) m6 === k5 || c5 && u6.data == k5 || (u6.data = k5);
    else {
      if (e5 = e5 && n2.call(u6.childNodes), !c5 && null != e5) for (m6 = {}, a5 = 0; a5 < u6.attributes.length; a5++) m6[(y6 = u6.attributes[a5]).name] = y6.value;
      for (a5 in m6) y6 = m6[a5], "dangerouslySetInnerHTML" == a5 ? p6 = y6 : "children" == a5 || a5 in k5 || "value" == a5 && "defaultValue" in k5 || "checked" == a5 && "defaultChecked" in k5 || N2(u6, a5, null, y6, o5);
      for (a5 in k5) y6 = k5[a5], "children" == a5 ? v5 = y6 : "dangerouslySetInnerHTML" == a5 ? h6 = y6 : "value" == a5 ? w6 = y6 : "checked" == a5 ? _6 = y6 : c5 && "function" != typeof y6 || m6[a5] === y6 || N2(u6, a5, y6, m6[a5], o5);
      if (h6) c5 || p6 && (h6.__html == p6.__html || h6.__html == u6.innerHTML) || (u6.innerHTML = h6.__html), t5.__k = [];
      else if (p6 && (u6.innerHTML = ""), L2("template" == t5.type ? u6.content : u6, g2(v5) ? v5 : [v5], t5, i5, r5, "foreignObject" == x6 ? "http://www.w3.org/1999/xhtml" : o5, e5, f6, e5 ? e5[0] : i5.__k && $2(i5, 0), c5, s5), null != e5) for (a5 = e5.length; a5--; ) b2(e5[a5]);
      c5 || (a5 = "value", "progress" == x6 && null == w6 ? u6.removeAttribute("value") : null != w6 && (w6 !== u6[a5] || "progress" == x6 && !w6 || "option" == x6 && w6 != m6[a5]) && N2(u6, a5, w6, m6[a5], o5), a5 = "checked", null != _6 && _6 != u6[a5] && N2(u6, a5, _6, m6[a5], o5));
    }
    return u6;
  }
  ...
  function K2(n4, u6, t5) {
    var i5, r5;
    if (l2.unmount && l2.unmount(n4), (i5 = n4.ref) && (i5.current && i5.current != n4.__e || J2(i5, null, u6)), null != (i5 = n4.__c)) {
    ...
    if (i5 = n4.__k) for (r5 = 0; r5 < i5.length; r5++) i5[r5] && K2(i5[r5], u6, t5 || "function" != typeof n4.type);
  ...
  function R2(u6, t5, i5) {
    var r5, o5, e5, f6;
    t5 == document && (t5 = document.documentElement), l2.__ && l2.__(u6, t5), o5 = (r5 = "function" == typeof i5) ? null : i5 && i5.__k || t5.__k, e5 = [], f6 = [], q2(t5, u6 = (!r5 && i5 || t5).__k = k2(S2, null, [u6]), o5 || d2, d2, t5.namespaceURI, !r5 && i5 ? [i5] : o5 ? null : t5.firstChild ? n2.call(t5.childNodes) : null, e5, !r5 && i5 ? i5 : o5 ? o5.__e : t5.firstChild, r5, f6), D2(e5, u6, f6);
  }
  function X2(n4) {
    function l6(n5) {
      var u6, t5;
  ...
  }, C2.prototype.setState = function(n4, l6) {
    var u6;
    u6 = null != this.__s && this.__s != this.state ? this.__s : this.__s = m2({}, this.state), "function" == typeof n4 && (n4 = n4(m2({}, u6), this.props)), n4 && m2(u6, n4), null != n4 && this.__v && (l6 && this._sb.push(l6), A2(this));
  }, C2.prototype.forceUpdate = function(n4) {
    this.__v && (this.__e = true, n4 && this.__h.push(n4), A2(this));
  }, C2.prototype.render = S2, i2 = [], o2 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, e2 = function(n4, l6) {
    return n4.__v.__b - l6.__v.__b;
  }, H2.__r = 0, f2 = Math.random().toString(8), c2 = "__d" + f2, s2 = "__a" + f2, a2 = /(PointerCapture)$|Capture$/i, h2 = 0, p2 = V2(false), v2 = V2(true), y2 = 0;
  ...
  c3.__b = function(n4) {
    ...
    v3 && v3(n4);
    var t5 = n4.__c;
    t5 && t5.__H && (t5.__H.__h.length && (1 !== f3.push(t5) && i3 === c3.requestAnimationFrame || ((i3 = c3.requestAnimationFrame) || w3)(j3)), t5.__H.__.some(function(n5) {
  ...
  function a4(i5) {
    if (void 0 !== r4) {
      ...
      if (void 0 === t5 || t5.t !== r4) {
        t5 = { i: 0, S: i5, p: r4.s, n: void 0, t: r4, e: void 0, x: void 0, r: t5 };
        if (void 0 !== r4.s) r4.s.n = t5;
        r4.s = t5;
        i5.n = t5;
        if (32 & r4.f) i5.S(t5);
        return t5;
  ...
  Object.defineProperty(l4.prototype, "value", { get: function() {
    ...
    if (i5 !== this.v) {
      if (v4 > 100) throw new Error("Cycle detected");
      !(function(i6) {
        if (0 !== s4 && 0 === v4) {
          if (i6.l !== e4) {
            i6.l = e4;
  ...
  var d5;
  var h5;
  var p5 = "undefined" != typeof window && !!window.__PREACT_SIGNALS_DEVTOOLS__;
  var m5 = [];
  var _4 = [];
  j4(function() {
    l5 = this.N;
  ...
  function g4(i5, r5) {
    l2[i5] = r5.bind(null, l2[i5] || function() {
    });
  }
  function b4(i5) {
    if (h5) {
  ...
  g4("__e", function(i5, n4, r5, t5) {
    b4();
    d5 = void 0;
    i5(n4, r5, t5);
  });
  g4("diffed", function(i5, n4) {
    b4();
    d5 = void 0;
    var r5;
    if ("string" == typeof n4.type && (r5 = n4.__e)) {
      ...
      if (t5) {
        ...
        for (var s5 in t5) o5[s5] = t5[s5];
      }
    }
    i5(n4);
  });
  function w5(i5, n4, r5, t5) {
    var o5 = n4 in i5 && void 0 === i5.ownerSVGElement, e5 = y4(r5), f6 = r5.peek();
  ...
  g4("__h", function(i5, n4, r5, t5) {
    if (t5 < 3 || 9 === t5) n4.__$f |= 2;
    i5(n4, r5, t5);
  });
  C2.prototype.shouldComponentUpdate = function(i5, n4) {
  ...
  function A4() {
    n3(function() {
      var i5;
      while (i5 = m5.shift()) l5.call(i5);
    });
  }
  function T5() {
    if (1 === m5.push(this)) (l2.requestAnimationFrame || k4)(A4);
  }
  function x5() {
    n3(function() {
      var i5;
      while (i5 = _4.shift()) l5.call(i5);
    });
  }
  function F3() {
    if (1 === _4.push(this)) (l2.requestAnimationFrame || q3)(x5);
  }
  ...
  function u5(e5, t5, n4, o5, i5, u6) {
    ...
    var l6 = { type: e5, props: p6, key: n4, ref: a5, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --f5, __i: -1, __u: 0, __source: i5, __self: u6 };
  ...
  (M3.prototype = new C2()).isPureReactComponent = true, M3.prototype.shouldComponentUpdate = function(n4, t5) {
  ...
  l2.unmount = function(n4) {
  ...
  }, (P4.prototype = new C2()).__c = function(n4, t5) {
    var e5 = t5.__c, r5 = this;
    null == r5.o && (r5.o = []), r5.o.push(e5);
    var u6 = j5(r5.__v), o5 = false, i5 = function() {
    ...
    var c5 = function() {
      if (!--r5.__u) {
        if (r5.state.__a) {
          var n5 = r5.state.__a;
          r5.__v.__k[0] = W3(n5, n5.__c.__P, n5.__c.__O);
        }
        var t6;
  ...
  function $3(n4, e5) {
    var r5 = k2(Y2, { __v: n4, h: e5 });
    return r5.containerInfo = e5, r5;
  }
  (B4.prototype = new C2()).__a = function(n4) {
    var t5 = this, e5 = j5(t5.__v), r5 = t5.l.get(n4);
  ...
  var q5 = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103;
  ...
  C2.prototype.isReactComponent = true, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(t5) {
    Object.defineProperty(C2.prototype, t5, { configurable: true, get: function() {
  ...
  l2.event = function(n4) {
    return en2 && (n4 = en2(n4)), n4.persist = function() {
  ...
  var rn2;
  var un2 = { configurable: true, get: function() {
    return this.class;
  } };
  var on2 = l2.vnode;
    ...
    "string" == typeof n4.type && (function(n5) {
      ...
      for (var i5 in t5) {
        ...
        if (!("value" === i5 && "defaultValue" in t5 && null == l6 || Q3 && "children" === i5 && "noscript" === e5 || "class" === i5 || "className" === i5)) {
          ...
          "defaultValue" === i5 && "value" in t5 && null == t5.value ? i5 = "value" : "download" === i5 && true === l6 ? l6 = "" : "translate" === c5 && "no" === l6 ? l6 = false : "o" === c5[0] && "n" === c5[1] ? "ondoubleclick" === c5 ? i5 = "ondblclick" : "onchange" !== c5 || "input" !== e5 && "textarea" !== e5 || X3(t5.type) ? "onfocus" === c5 ? i5 = "onfocusin" : "onblur" === c5 ? i5 = "onfocusout" : J3.test(i5) && (i5 = c5) : c5 = i5 = "oninput" : o5 && G3.test(i5) ? i5 = i5.replace(K3, "-$&").toLowerCase() : null === l6 && (l6 = void 0), "oninput" === c5 && u6[i5 = c5] && (i5 = "oninputCapture"), u6[i5] = l6;
        }
      }
      ...
      }))), t5.class && !t5.className ? (u6.class = t5.class, Object.defineProperty(u6, "className", un2)) : t5.className && (u6.class = u6.className = t5.className), n5.props = u6;
    })(n4), n4.$$typeof = q5, on2 && on2(n4);
  };
  var ln2 = l2.__r;
  l2.__r = function(n4) {
    ln2 && ln2(n4), rn2 = n4.__c;
  };
  var cn2 = l2.diffed;
  l2.diffed = function(n4) {
    cn2 && cn2(n4);
    var t5 = n4.props, e5 = n4.__e;
    null != e5 && "textarea" === n4.type && "value" in t5 && t5.value !== e5.value && (e5.value = null == t5.value ? "" : t5.value), rn2 = null;
  };
  ...
  function AppInput() {
    ...
    return u5(S2, { children: u5("div", { className: wrapperClasses.join(" "), id: inputWrapperId, children: [u5("label", { for: datePickerInputId, id: datePickerLabelId, className: "sx__date-input-label", children: $app.config.label || $app.translate("Date") }), u5("input", { id: datePickerInputId, tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, name: $app.config.name || "date", "aria-describedby": datePickerLabelId, value: $app.datePickerState.inputDisplayedValue.value, "data-testid": "date-picker-input", className: "sx__date-input", onClick: handleClick, onKeyUp: handleKeyUp, type: "text" }), u5("button", { type: "button", tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, "aria-label": $app.translate("Choose Date"), onKeyDown: handleButtonKeyDown, onClick: () => $app.datePickerState.open(), className: "sx__button sx__date-input-chevron-wrapper", children: u5("img", { className: "sx__date-input-chevron", src: img, alt: "" }) })] }) });
  }
  var DatePickerView;
  ...
  function Chevron({ direction, onClick, buttonText, disabled = false }) {
    ...
    return u5("button", { type: "button", disabled, className: "sx__button sx__chevron-wrapper sx__ripple", onMouseUp: onClick, onKeyDown: handleKeyDown, tabIndex: 0, children: u5("i", { className: `sx__chevron sx__chevron--${direction}`, children: buttonText }) });
  }
  function MonthViewHeader({ setYearsView }) {
    ...
    return u5(S2, { children: u5("header", { className: "sx__date-picker__month-view-header", children: [u5(Chevron, { direction: "previous", onClick: () => setPreviousMonth(), buttonText: $app.translate("Previous month") }), u5("button", { type: "button", className: "sx__button sx__date-picker__month-view-header__month-year", onClick: (event) => handleOpenYearsView(event), children: selectedDateMonthName + " " + datePickerYear }), u5(Chevron, { direction: "next", onClick: () => setNextMonth(), buttonText: $app.translate("Next month") })] }) });
  }
  function DayNames() {
    const $app = x3(AppContext$1);
    ...
    return u5("div", { className: "sx__date-picker__day-names", children: dayNames.map((dayName) => u5("span", { "data-testid": "day-name", className: "sx__date-picker__day-name", children: dayName })) });
  }
  ...
  function TimeIcon({ strokeColor }) {
    return u5(S2, { children: u5("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u5("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u5("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u5("g", { id: "SVGRepo_iconCarrier", children: [u5("path", { d: "M12 8V12L15 15", stroke: strokeColor, "stroke-width": "2", "stroke-linecap": "round" }), u5("circle", { cx: "12", cy: "12", r: "9", stroke: strokeColor, "stroke-width": "2" })] })] }) });
  }
  function UserIcon({ strokeColor }) {
    return u5(S2, { children: u5("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u5("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u5("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u5("g", { id: "SVGRepo_iconCarrier", children: [u5("path", { d: "M15 7C15 8.65685 13.6569 10 12 10C10.3431 10 9 8.65685 9 7C9 5.34315 10.3431 4 12 4C13.6569 4 15 5.34315 15 7Z", stroke: strokeColor, "stroke-width": "2" }), u5("path", { d: "M5 19.5C5 15.9101 7.91015 13 11.5 13H12.5C16.0899 13 19 15.9101 19 19.5V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V19.5Z", stroke: strokeColor, "stroke-width": "2" })] })] }) });
  }
  function LocationPinIcon({ strokeColor }) {
    return u5(S2, { children: u5("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u5("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u5("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u5("g", { id: "SVGRepo_iconCarrier", children: [u5("g", { "clip-path": "url(#clip0_429_11046)", children: [u5("rect", { x: "12", y: "11", width: "0.01", height: "0.01", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" }), u5("path", { d: "M12 22L17.5 16.5C20.5376 13.4624 20.5376 8.53757 17.5 5.5C14.4624 2.46244 9.53757 2.46244 6.5 5.5C3.46244 8.53757 3.46244 13.4624 6.5 16.5L12 22Z", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" })] }), u5("defs", { children: u5("clipPath", { id: "clip0_429_11046", children: u5("rect", { width: "24", height: "24", fill: "white" }) }) })] })] }) });
  }
  ...
  var PreactView = class {
    ...
    render(onElement, $app) {
      R2(k2(this.Component, { $app, id: this.randomId }), onElement);
    }
    destroy() {
  ...
  function MonthViewWeek({ week }) {
    ...
    return u5(S2, { children: u5("div", { "data-testid": DATE_PICKER_WEEK, className: "sx__date-picker__week", children: weekDays.map((weekDay) => u5("button", { type: "button", tabIndex: hasFocus(weekDay) ? 0 : -1, disabled: !isDateSelectable(weekDay.day), "aria-label": getLocalizedDate$1($app.datePickerState.datePickerDate.value, $app.config.locale.value), className: `sx__button ${weekDay.classes.join(" ")}`, "data-focus": hasFocus(weekDay) ? "true" : void 0, onClick: () => selectDate(weekDay.day), onKeyDown: handleKeyDown, children: weekDay.day.day })) }) });
  }
  function MonthView({ seatYearsView }) {
    ...
    return u5(S2, { children: u5("div", { id: elementId, "data-testid": MONTH_VIEW, className: "sx__date-picker__month-view", children: [u5(MonthViewHeader, { setYearsView: seatYearsView }), u5(DayNames, {}), month.map((week) => u5(MonthViewWeek, { week }))] }) });
  }
  function YearsViewAccordion({ year, setYearAndMonth, isExpanded, expand }) {
    ...
    return u5(S2, { children: u5("li", { className: isExpanded ? "sx__is-expanded" : "", children: [u5("button", { type: "button", className: "sx__button sx__date-picker__years-accordion__expand-button sx__ripple--wide", onClick: () => expand(year), children: year }), isExpanded && u5("div", { className: "sx__date-picker__years-view-accordion__panel", children: yearWithDates.map((month) => u5("button", { type: "button", className: "sx__button sx__date-picker__years-view-accordion__month", onClick: (event) => handleClickOnMonth(event, month), children: toLocalizedMonth(month, $app.config.locale.value) })) })] }) });
  }
  function YearsView({ setMonthView }) {
    ...
    return u5(S2, { children: u5("ul", { className: "sx__date-picker__years-view", "data-testid": YEARS_VIEW, children: years.map((year) => u5(YearsViewAccordion, { year, setYearAndMonth: (year2, month) => setNewDatePickerDate(year2, month), isExpanded: expandedYear === year, expand: (year2) => setExpandedYear(year2) })) }) });
  }
  var isScrollable = (el) => {
    if (el) {
  ...
  function AppPopup({ wrapperEl }) {
    ...
    return u5(S2, { children: u5("div", { style: $app.config.teleportTo ? fixedPositionStyle : void 0, "data-testid": "date-picker-popup", className: classList.join(" "), children: datePickerView === DatePickerView.MONTH_DAYS ? u5(MonthView, { seatYearsView: () => setDatePickerView(DatePickerView.YEARS) }) : u5(YearsView, { setMonthView: () => setDatePickerView(DatePickerView.MONTH_DAYS) }) }) });
  }
  function AppWrapper({ $app }) {
    ...
    let appPopupJSX = u5(AppPopup, { wrapperEl: elementRef.current });
    if ($app.config.teleportTo)
      appPopupJSX = $3(appPopupJSX, $app.config.teleportTo);
    return u5(S2, { children: u5("div", { ref: elementRef, className: classList.join(" "), children: u5(AppContext$1.Provider, { value: $app, children: [u5(AppInput, {}), $app.datePickerState.isOpen.value && appPopupJSX] }) }) });
  }
  ...
  function RangeHeading() {
    ...
    return u5("span", { className: "sx__range-heading", children: currentHeading });
  }
  function TodayButton() {
    ...
    return u5("button", { type: "button", className: "sx__button sx__today-button sx__ripple", onClick: setToday, children: $app.translate("Today") });
  }
  function ViewSelection() {
    ...
    return u5("div", { className: `sx__view-selection ${isOpen ? "is-open" : ""}`, children: [u5("label", { for: viewSelectId, id: viewLabelId, className: "sx__view-selection-label", children: $app.translate("View") }), u5("div", { id: viewSelectId, tabIndex: 0, role: "button", "aria-describedby": viewLabelId, "aria-label": $app.translate("Select View"), className: "sx__view-selection-selected-item sx__ripple", onClick: () => setIsOpen(!isOpen), onKeyDown: handleSelectedViewKeyDown, children: [selectedViewLabel, u5("img", { className: "sx__view-selection-chevron", src: img, alt: "" })] }), isOpen && u5("ul", { "data-testid": "view-selection-items", className: "sx__view-selection-items", children: availableViews.map((view) => u5("li", { "aria-label": $app.translate("Select View") + " " + $app.translate(view.label), tabIndex: -1, role: "button", onKeyDown: (keyboardEvent) => navigateUpOrDown(keyboardEvent, view.name), onClick: () => handleClickOnSelectionItem(view.name), className: "sx__view-selection-item" + (view.name === $app.calendarState.view.value ? " is-selected" : ""), children: $app.translate(view.label) })) })] });
  }
  function ForwardBackwardNavigation() {
    ...
    return u5(S2, { children: u5("div", { className: "sx__forward-backward-navigation", "aria-label": localizedRange, "aria-live": "polite", children: [u5(Chevron, { disabled: !!($app.config.minDate.value && dateFromDateTime((_a = rangeEndMinusOneRange === null || rangeEndMinusOneRange === void 0 ? void 0 : rangeEndMinusOneRange.toString()) !== null && _a !== void 0 ? _a : "") < $app.config.minDate.value.toString()), onClick: () => navigate("backwards"), direction: "previous", buttonText: $app.translate("Previous period") }), u5(Chevron, { disabled: !!($app.config.maxDate.value && rangeStartPlusOneRange && dateFromDateTime(rangeStartPlusOneRange.toString()) > $app.config.maxDate.value.toString()), onClick: () => navigate("forwards"), direction: "next", buttonText: $app.translate("Next period") })] }) });
  }
  ...
  function TimeGridEvent({ calendarEvent, dayBoundariesDateTime, isCopy, setMouseDown }) {
    ...
    }, children: u5("div", { "data-ccid": customComponentId.current, className: "sx__time-grid-event-inner", children: [!customComponent && !hasCustomContent && u5(S2, { children: [isCompact && calendarEvent.title && u5("div", { className: "sx__title-and-time-compact", children: [u5("div", { className: "sx__time-grid-event-title", children: calendarEvent.title }), u5("div", { className: "sx__time-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) })] }), !isCompact && calendarEvent.title && u5("div", { className: "sx__time-grid-event-title", children: calendarEvent.title }), (!isCompact || isCompact && !calendarEvent.title) && u5("div", { className: "sx__time-grid-event-time", children: [u5(TimeIcon, { strokeColor: eventCSSVariables.iconStroke }), getEventTime(calendarEvent.start, calendarEvent.end)] }), calendarEvent.people && calendarEvent.people.length > 0 && u5("div", { className: "sx__time-grid-event-people", children: [u5(UserIcon, { strokeColor: eventCSSVariables.iconStroke }), concatenatePeople(calendarEvent.people)] }), calendarEvent.location && u5("div", { className: "sx__time-grid-event-location", children: [u5(LocationPinIcon, { strokeColor: eventCSSVariables.iconStroke }), calendarEvent.location] })] }), hasCustomContent && u5("div", { dangerouslySetInnerHTML: {
      __html: ((_d = calendarEvent._customContent) === null || _d === void 0 ? void 0 : _d.timeGrid) || ""
    } }), $app.config.plugins.resize && !((_e2 = calendarEvent._options) === null || _e2 === void 0 ? void 0 : _e2.disableResize) && u5("div", { className: "sx__time-grid-event-resize-handle", onMouseDown: startResize, onTouchStart: startResize })] }) }), eventCopy && u5(TimeGridEvent, { calendarEvent: eventCopy, isCopy: true, setMouseDown, dayBoundariesDateTime })] });
  }
  ...
  function TimeGridBackgroundEvent({ backgroundEvent, date }) {
    ...
    return u5(S2, { children: u5("div", { class: "sx__time-grid-background-event", title: backgroundEvent.title, style: {
  ...
  function TimeAxis() {
    ...
    return u5(S2, { children: u5("div", { className: "sx__week-grid__time-axis", children: gridSteps.map((gridStep, index) => u5("div", { className: "sx__week-grid__hour", children: [hourCustomComponentFn && hourCCIDs.length && u5("div", { "data-ccid": hourCCIDs[index] }), !hourCustomComponentFn && u5("span", { className: "sx__week-grid__hour-text", children: formatter.format(new Date(0, 0, 0, gridStep.hour, gridStep.minute)) })] })) }) });
  }
  function DateAxis({ week }) {
    ...
    return u5(S2, { children: u5("div", { className: "sx__week-grid__date-axis", children: week.map((date, idx) => u5("div", { className: getClassNames(date), "data-date": toDateString$1(date), children: [weekGridDateCustomComponentFn && u5("div", { "data-ccid": weekGridDateCCIDs[0][idx] }), !weekGridDateCustomComponentFn && u5(S2, { children: [u5("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale.value) }), u5("div", { className: "sx__week-grid__date-number", children: date.day })] })] })) }) });
  }
  ...
  function DateGridEvent({ calendarEvent, gridRow, isCopy }) {
    ...
    }, children: [!customComponent && !hasCustomContent && u5(S2, { children: [hasOverflowLeft && u5("div", { className: "sx__date-grid-event--left-overflow", style: overflowStyles }), u5("span", { className: "sx__date-grid-event-text", children: [calendarEvent.title, " \xA0", calendarEvent.start instanceof Temporal.ZonedDateTime && u5("span", { className: "sx__date-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) })] }), hasOverflowRight && u5("div", { className: "sx__date-grid-event--right-overflow", style: overflowStyles })] }), hasCustomContent && u5("div", { dangerouslySetInnerHTML: {
      __html: ((_c = calendarEvent._customContent) === null || _c === void 0 ? void 0 : _c.dateGrid) || ""
    } }), $app.config.plugins.resize && !((_d = calendarEvent._options) === null || _d === void 0 ? void 0 : _d.disableResize) && !endsAfterWeek && u5("div", { className: "sx__date-grid-event-resize-handle", onMouseDown: startResize, onTouchStart: startResize })] }), eventCopy && u5(DateGridEvent, { calendarEvent: eventCopy, gridRow, isCopy: true })] });
  }
  function DateGridDay({ calendarEvents, date, backgroundEvents }) {
    ...
    return u5("div", { className: "sx__date-grid-day", "data-date-grid-date": date, children: [fullDayBackgroundEvent && u5("div", { className: "sx__date-grid-background-event", title: fullDayBackgroundEvent.title, style: {
      ...fullDayBackgroundEvent.style
    } }), Object.values(calendarEvents).map((event, index) => {
      if (event === DATE_GRID_BLOCKER || !event)
        return u5("div", { className: "sx__date-grid-cell", style: { gridRow: index + 1 }, onMouseDown: handleMouseDown });
      return u5(DateGridEvent, { calendarEvent: event, gridRow: index + 1 }, event.start.toString() + event.end.toString() + index);
    }), u5("div", { className: "sx__spacer", onMouseDown: handleMouseDown })] });
  }
  ...
  var WeekWrapper = ({ $app, id }) => {
    ...
    return u5(S2, { children: u5(AppContext.Provider, { value: $app, children: u5("div", { className: "sx__week-wrapper", id, children: [u5("div", { className: "sx__week-header", children: u5("div", { className: "sx__week-header-content", children: [u5(DateAxis, { week: Object.values(week.value).map((day) => {
    ...
    }) }), u5("div", { className: "sx__date-grid", "aria-label": $app.translate("Full day- and multiple day events"), children: Object.values(week.value).map((day) => u5(DateGridDay, { date: day.date, calendarEvents: day.dateGridEvents, backgroundEvents: day.backgroundEvents }, day.date)) }), u5("div", { className: "sx__week-header-border" })] }) }), u5("div", { className: "sx__week-grid", children: [u5(TimeAxis, {}), Object.values(week.value).map((day) => {
      ...
      return u5(TimeGridDay, { calendarEvents: day.timeGridEvents, backgroundEvents: day.backgroundEvents, date: zonedDateTime }, day.date);
    })] })] }) }) });
  };
  ...
  var DayWrapper = ({ $app, id }) => {
    return u5(WeekWrapper, { "$app": $app, id });
  };
  var config$3 = {
  ...
  function WeekNumber() {
    const $app = x3(AppContext);
    return u5("div", { className: "sx__calendar-header__week-number", children: $app.translate("CW", {
  ...
  function CalendarHeader() {
    ...
    return u5("header", { className: "sx__calendar-header", "data-ccid": headerContentId, children: !headerContent && u5(S2, { children: [u5("div", { className: "sx__calendar-header-content", children: [headerContentLeftPrependId && u5("div", { "data-ccid": headerContentLeftPrependId }), u5(TodayButton, {}), u5(ForwardBackwardNavigation, {}), u5(RangeHeading, {}, $app.config.locale.value), $app.config.showWeekNumbers.value && isDayOrWeekView && u5(WeekNumber, {}), headerContentLeftAppendId && u5("div", { "data-ccid": headerContentLeftAppendId })] }), u5("div", { className: "sx__calendar-header-content", children: [headerContentRightPrependId && u5("div", { "data-ccid": headerContentRightPrependId }), $app.config.plugins.timezoneSelect && $app.config.plugins.timezoneSelect.isEnabled.value && u5($app.config.plugins.timezoneSelect.ComponentFn, { "$app": $app }), $app.config.views.value.length > 1 && u5(ViewSelection, {}, keyForRerenderingOnLocaleChange + "-view-selection"), u5(AppWrapper, { "$app": datePickerAppSingleton }), headerContentRightAppendId && u5("div", { "data-ccid": headerContentRightAppendId })] })] }) });
  }
  ...
  function CalendarWrapper({ $app }) {
    ...
    return u5(S2, { children: u5("div", { className: wrapperClasses.join(" "), id: calendarId, children: u5("div", { className: "sx__calendar", children: u5(AppContext.Provider, { value: $app, children: [u5(CalendarHeader, {}), u5("div", { className: ["sx__view-container", transitionClass].join(" "), id: viewContainerId }), $app.config.plugins.eventModal && $app.config.plugins.eventModal.calendarEvent.value && u5($app.config.plugins.eventModal.ComponentFn, { "$app": $app }, (_a = $app.config.plugins.eventModal.calendarEvent.value) === null || _a === void 0 ? void 0 : _a.id)] }) }) }) });
  }
  ...
  var CalendarApp = class {
    ...
    render(el) {
      ...
      R2(k2(CalendarWrapper, { $app: this.$app }), el);
    }
    destroy() {
      Object.values(this.$app.config.plugins || {}).forEach((plugin) => {
      ...
      if (this.calendarContainerEl) {
        R2(null, this.calendarContainerEl);
      }
    }
    setTheme(theme) {
  ...
  var createDatePickerState = (config2, selectedDateParam) => {
    ...
    const isOpen = y4(false);
    const isDisabled = y4(config2.disabled || false);
    const datePickerView = y4(DatePickerView.MONTH_DAYS);
    const selectedDate = y4(initialSelectedDate);
    const datePickerDate = y4(initialSelectedDate);
    const isDark = y4(((_a = config2.style) === null || _a === void 0 ? void 0 : _a.dark) || false);
    const inputDisplayedValue = y4(toLocalizedDateString(initialSelectedDate, config2.locale.value));
    const lastValidDisplayedValue = y4(inputDisplayedValue.value);
  ...
  var createCalendarState = (calendarConfig, timeUnitsImpl, selectedDate) => {
    var _a;
    const _view = y4(((_a = calendarConfig.views.value.find((view2) => view2.name === calendarConfig.defaultView)) === null || _a === void 0 ? void 0 : _a.name) || calendarConfig.views.value[0].name);
    const view = g3(() => {
      return _view.value;
    });
    const range = y4(null);
    ...
    const isCalendarSmall = y4(void 0);
    const isDark = y4(calendarConfig.isDark.value || false);
    j4(() => {
  ...
  var createCalendarEventsImpl = (events, backgroundEvents, config2) => {
    const list = y4(events.map((event) => {
      return externalEventToInternal(event, config2);
    }));
    const filterPredicate = y4(void 0);
    return {
      list,
      filterPredicate,
      backgroundEvents: y4(backgroundEvents)
    };
  };
  ...
  var CalendarConfigImpl = class {
    constructor(locale = DEFAULT_LOCALE, firstDayOfWeek = DEFAULT_FIRST_DAY_OF_WEEK, defaultView = InternalViewName.Week, views = [], dayBoundaries = DEFAULT_DAY_BOUNDARIES, weekOptions, calendars = {}, plugins = {}, isDark = false, isResponsive = true, callbacks = {}, _customComponentFns = {}, minDate = void 0, maxDate = void 0, monthGridOptions = {
      ...
      this.locale = y4(locale);
      this.firstDayOfWeek = y4(firstDayOfWeek);
      this.views = y4(views);
      this.dayBoundaries = y4(dayBoundaries);
      this.weekOptions = y4(weekOptions);
      this.calendars = y4(calendars);
      this.isDark = y4(isDark);
      this.minDate = y4(minDate);
      this.maxDate = y4(maxDate);
      this.monthGridOptions = y4(monthGridOptions);
      this.theme = theme;
      this.translations = y4(translations2);
      this.showWeekNumbers = y4(showWeekNumbers);
      this.direction = getDirection();
      this.timezone = y4(timezone);
      this.resources = y4(resources);
      this.resourceGridOptions = y4(resourceGridOptions);
    }
    get isHybridDay() {
  ...
  function MonthGridEvent({ gridRow, calendarEvent, date, isFirstWeek, isLastWeek }) {
    ...
    return u5("div", { draggable: !!$app.config.plugins.dragAndDrop, "data-event-id": calendarEvent.id, "data-ccid": customComponentId.current, onMouseDown: (e5) => createDragStartTimeout(handleStartDrag, e5), onMouseUp: (e5) => setClickedEventIfNotDragging(calendarEvent, e5), onTouchStart: (e5) => createDragStartTimeout(handleStartDrag, e5), onTouchEnd: (e5) => setClickedEventIfNotDragging(calendarEvent, e5), onClick: handleOnClick, onDblClick: handleOnDoubleClick, onKeyDown: handleKeyDown, className: classNames.join(" "), style: {
      ...
      color: customComponent ? void 0 : eventCSSVariables.color,
      backgroundColor: customComponent ? void 0 : eventCSSVariables.backgroundColor
    }, tabIndex: 0, role: "button", children: [!customComponent && !hasCustomContent && u5(S2, { children: [calendarEvent.start instanceof Temporal.ZonedDateTime && u5("div", { className: "sx__month-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) }), u5("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })] }), hasCustomContent && u5("div", { dangerouslySetInnerHTML: {
  ...
  function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
    ...
    return u5("div", { className: wrapperClasses.join(" "), "data-date": toDateString$1(day.date), onClick: (e5) => $app.config.callbacks.onClickDate && $app.config.callbacks.onClickDate(day.date, e5), "aria-label": getLocalizedDate$1(day.date, $app.config.locale.value), onDblClick: (e5) => {
      var _a, _b;
      return (_b = (_a = $app.config.callbacks).onDoubleClickDate) === null || _b === void 0 ? void 0 : _b.call(_a, day.date, e5);
    }, onMouseDown: handleMouseDown, children: [fullDayBackgroundEvent && u5(S2, { children: u5("div", { className: "sx__month-grid-background-event", title: fullDayBackgroundEvent.title, style: {
      ...fullDayBackgroundEvent.style
    } }) }), u5("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? u5(S2, { children: monthGridDayNameCustomComponent ? u5("div", { "data-ccid": monthGridDayNameCCID }) : u5("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale.value) }) }) : null, monthGridDateCCID ? u5("div", { "data-ccid": monthGridDateCCID }) : u5("div", { className: dateClassNames.join(" "), children: dayDate.day })] }), u5("div", { className: "sx__month-grid-day__events", children: Object.values(day.events).slice(0, $app.config.monthGridOptions.value.nEventsPerDay).map((event, index) => {
      if (typeof event !== "object")
        return u5("div", { className: "sx__month-grid-blocker sx__month-grid-cell", style: { gridRow: index + 1 } });
      return u5(MonthGridEvent, { gridRow: index + 1, calendarEvent: event, date: day.date.toString(), isFirstWeek, isLastWeek });
    }) }), numberOfNonDisplayedEvents > 0 ? u5("button", { type: "button", className: "sx__button sx__month-grid-day__events-more sx__ripple--wide", "aria-label": getAriaLabelSingularOrPlural(numberOfNonDisplayedEvents), onClick: handleClickAdditionalEvents, children: getEventTranslationSingularOrPlural(numberOfNonDisplayedEvents) }) : null] });
  }
  function MonthGridWeek({ week, isFirstWeek, isLastWeek }) {
    const $app = x3(AppContext);
    return u5("div", { className: "sx__month-grid-week", children: [$app.config.showWeekNumbers.value && u5("div", { className: "sx__month-grid-week__week-number", children: getWeekNumber(week[0].date, $app.config.firstDayOfWeek.value) }), week.map((day) => {
      return u5(MonthGridDay, { day, isFirstWeek, isLastWeek }, toDateString$1(day.date));
    })] });
  }
  ...
  var MonthGridWrapper = ({ $app, id }) => {
    ...
    return u5(AppContext.Provider, { value: $app, children: u5("div", { id, className: "sx__month-grid-wrapper", children: month.map((week, index) => u5(MonthGridWeek, { week, isFirstWeek: index === 0, isLastWeek: index === month.length - 1 }, index)) }) });
  };
  var config$2 = {
  ...
  function MonthAgendaDay({ day, isActive, setActiveDate }) {
    ...
    return u5("button", { type: "button", className: `sx__button ${dayClasses.join(" ")}`, onClick: (e5) => handleClick(e5, $app.config.callbacks.onClickAgendaDate), onDblClick: (e5) => handleClick(e5, $app.config.callbacks.onDoubleClickAgendaDate), disabled: isBeforeMinDate || isPastMaxDate, "aria-label": getLocalizedDate$1(day.date, $app.config.locale.value), tabIndex: hasFocus(day) ? 0 : -1, "data-agenda-focus": hasFocus(day) ? "true" : void 0, onKeyDown: handleKeyDown, children: [u5("div", { children: day.date.day }), u5("div", { className: "sx__month-agenda-day__event-icons", children: day.events.slice(0, 3).map((event) => u5("div", { style: { backgroundColor: `var(--sx-color-${event._color})` }, className: "sx__month-agenda-day__event-icon" })) })] });
  }
  function MonthAgendaWeek({ week, setActiveDate, activeDate }) {
    const $app = x3(AppContext);
    return u5("div", { className: "sx__month-agenda-week", children: [$app.config.showWeekNumbers.value && u5("div", { className: "sx__month-agenda-week__week-number", children: getWeekNumber(Temporal.PlainDate.from(week[0].date), $app.config.firstDayOfWeek.value) }), week.map((day, index) => u5(MonthAgendaDay, { setActiveDate, day, isActive: isSameDay(activeDate, day.date) }, index + day.date.toString()))] });
  }
  function MonthAgendaDayNames({ week }) {
    ...
    return u5("div", { className: classNames, children: localizedShortDayNames.map((oneLetterDayName) => u5("div", { className: "sx__month-agenda-day-name", children: oneLetterDayName })) });
  }
  ...
  function MonthAgendaEvent({ calendarEvent }) {
    ...
    if (wasEventAddedInLastSecond(calendarEvent))
      classNames.push("is-event-new");
    return u5("div", { className: classNames.join(" "), "data-ccid": customComponentId.current, "data-event-id": calendarEvent.id, style: {
      backgroundColor: customComponent ? void 0 : eventCSSVariables.backgroundColor,
      color: customComponent ? void 0 : eventCSSVariables.color,
      borderInlineStart: customComponent ? void 0 : eventCSSVariables.borderInlineStart,
      padding: customComponent ? "0px" : void 0
    }, onClick: (e5) => onClick(e5), onDblClick: (e5) => onDoubleClick(e5), onKeyDown, tabIndex: 0, role: "button", children: [!customComponent && !hasCustomContent && u5(S2, { children: [u5("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), u5("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [u5(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), u5("div", { dangerouslySetInnerHTML: {
  ...
  function MonthAgendaEvents({ events }) {
    const $app = x3(AppContext);
    return u5("div", { className: "sx__month-agenda-events", children: events.length ? events.map((event) => u5(MonthAgendaEvent, { calendarEvent: event }, event.id)) : u5("div", { className: "sx__month-agenda-events__empty", children: $app.translate("No events") }) });
  }
  var MonthAgendaWrapper = ({ $app, id }) => {
    ...
    return u5(AppContext.Provider, { value: $app, children: u5("div", { id, className: "sx__month-agenda-wrapper", children: [u5(MonthAgendaDayNames, { week: agendaMonth.weeks[0] }), u5("div", { className: "sx__month-agenda-weeks", children: agendaMonth.weeks.map((week, index) => u5(MonthAgendaWeek, { week, setActiveDate: (date) => $app.datePickerState.selectedDate.value = date, activeDate: $app.datePickerState.selectedDate.value }, index)) }), u5(MonthAgendaEvents, { events: ((_a = agendaMonth.weeks.flat().find((day) => isSameDay(day.date, $app.datePickerState.selectedDate.value))) === null || _a === void 0 ? void 0 : _a.events) || [] }, $app.datePickerState.selectedDate.value)] }) });
  };
  var config$1 = {
  ...
  var ListWrapper = ({ $app, id }) => {
    ...
    const renderEventTimes = (event, dayDate) => {
      ...
      if (!isMultiDay) {
        return u5(S2, { children: [u5("div", { className: "sx__list-event-start-time", children: startZDT.toLocaleString($app.config.locale.value, timeOptions) }), event.end && u5("div", { className: "sx__list-event-end-time", children: endZDT.toLocaleString($app.config.locale.value, timeOptions) })] });
      }
      if (isFirstDay) {
        return u5(S2, { children: [u5("div", { className: "sx__list-event-start-time", children: startZDT.toLocaleString($app.config.locale.value, timeOptions) }), u5("div", { className: "sx__list-event-arrow", children: "\u2192" })] });
      }
      if (isLastDay) {
        return u5(S2, { children: [u5("div", { className: "sx__list-event-arrow", children: "\u2190" }), u5("div", { className: "sx__list-event-end-time", children: endZDT.toLocaleString($app.config.locale.value, timeOptions) })] });
      }
      return u5("div", { className: "sx__list-event-arrow", children: "\u2194" });
    };
    ...
    return u5(AppContext.Provider, { value: $app, children: u5("div", { id, className: "sx__list-wrapper", ref: wrapperRef, children: daysWithEvents.length === 0 ? u5("div", { className: "sx__list-no-events", children: $app.translate("No events") }) : daysWithEvents.map((day) => u5("div", { className: "sx__list-day", "data-date": day.date, children: [u5("div", { className: "sx__list-day-header", children: u5("div", { className: "sx__list-day-date", children: toJSDate(day.date).toLocaleDateString($app.config.locale.value, {
      weekday: "long",
      year: "numeric",
      month: "long",
      day: "numeric"
    }) }) }), u5("div", { className: "sx__list-day-events", children: day.events.map((event) => {
      var _a;
      ...
      return u5("div", { className: classNames.join(" "), onClick: (e5) => handleEventClick(e5, event), onDblClick: (e5) => handleEventDoubleClick(e5, event), onKeyDown: (e5) => handleEventKeyDown(e5, event), tabIndex: 0, role: "button", children: [u5("div", { className: `sx__list-event-color-line`, style: {
        backgroundColor: `var(--sx-color-${event._color})`
      } }), u5("div", { className: "sx__list-event-content", children: [u5("div", { className: "sx__list-event-title", children: event.title }), u5("div", { className: "sx__list-event-times", children: renderEventTimes(event, day.date) })] })] }, event.id);
    }) }), u5("div", { className: "sx__list-day-margin" })] }, day.date)) }) });
  };
  var config = {
  ...
  // src/readonly.js
  var mountedCalendars = /* @__PURE__ */ new WeakMap();
  var scheduleXViewByLegacy = {
    dayGridMonth: "month",
    timeGridWeek: "week",
    timeGridDay: "day"
  };
  ...
  function rgbToHex({ r: r5, g: g7, b: b5 }) {
    return `#${[r5, g7, b5].map((value) => clamp(Math.round(value), 0, 255).toString(16).padStart(2, "0")).join("")}`;
  }
  function mixColor(hex, targetHex, weight) {
    const a5 = hexToRgb(hex);
    const b5 = hexToRgb(targetHex);
    if (!a5 || !b5) return hex || targetHex;
    return rgbToHex({
      r: a5.r + (b5.r - a5.r) * weight,
      g: a5.g + (b5.g - a5.g) * weight,
      b: a5.b + (b5.b - a5.b) * weight
    });
  }
  function contrastColor(hex) {
    const rgb = hexToRgb(hex);
    if (!rgb) return "#1c1b1f";
    const brightness = (rgb.r * 299 + rgb.g * 587 + rgb.b * 114) / 1e3;
    return brightness > 160 ? "#1c1b1f" : "#ffffff";
  }
  function buildCalendarPalette(color, fallbackLabel, readonly = true) {
    const main = color || "#1f7a8c";
    const container = mixColor(main, "#ffffff", readonly ? 0.16 : 0.1);
    return {
      colorName: fallbackLabel,
      label: fallbackLabel,
      readonly,
      lightColors: {
        main,
        container,
        onContainer: contrastColor(container)
      },
      darkColors: {
        main,
        container: mixColor(main, "#0f1720", 0.6),
        onContainer: "#f9fafb"
      }
    };
  }
  ...
  function formatTimeLabel(iso, timezone) {
    if (!iso) return "";
    const date = toTemporalDateTime(iso, timezone);
    if (!date) return "";
  ...
  function eventMarkup(event, palette, timezone, variant) {
    const main = palette?.lightColors?.main || "#1f7a8c";
    const background = palette?.lightColors?.container || mixColor(main, "#ffffff", 0.16);
    const foreground = palette?.lightColors?.onContainer || contrastColor(background);
    const time = formatTimeLabel(event.start, timezone);
    const title = escapeHtml(event.title || "Untitled event");
    if (variant === "month") {
      return `<span class="tg-sx-event tg-sx-event--month" style="--tg-event-main:${main};--tg-event-bg:${background};--tg-event-fg:${foreground};">${time ? `<span class="tg-sx-event__time">${escapeHtml(time)}</span>` : ""}<span class="tg-sx-event__title">${title}</span></span>`;
    }
    return `<div class="tg-sx-event tg-sx-event--detail" style="--tg-event-main:${main};--tg-event-bg:${background};--tg-event-fg:${foreground};"><span class="tg-sx-event__title">${title}</span>${time ? `<span class="tg-sx-event__time">${escapeHtml(time)}</span>` : ""}</div>`;
  }
  function toTemporalDateTime(iso, timezone) {
    if (!iso) return null;
    try {
  ...
  function toTemporalAllDayDate(value, fallbackDays = 0) {
    if (!value) return null;
    try {
      return Temporal.PlainDate.from(String(value).slice(0, 10)).add({ days: fallbackDays });
    } catch (_error) {
      return null;
    }
  }
  function toPlainDate(value) {
    ...
    try {
      if (typeof value === "string" && /^\d{4}-\d{2}-\d{2}$/.test(value)) return Temporal.PlainDate.from(value);
      return Temporal.Instant.from(value).toZonedDateTimeISO("UTC").toPlainDate();
    } catch (_error) {
      return Temporal.Now.plainDateISO();
    }
  }
  function isPlainDateValue(value) {
    return Boolean(value && typeof value === "object" && typeof value.year === "number" && typeof value.month === "number" && typeof value.day === "number" && typeof value.hour !== "number" && !value.epochMilliseconds);
  }
  function toEventDetailValue(value, timezone, { endOfDay = false } = {}) {
    if (!value) return "";
    if (value.epochMilliseconds) return new Date(value.epochMilliseconds).toISOString();
    if (isPlainDateValue(value)) return value.toString();
    try {
      if (typeof value.toZonedDateTime === "function") {
        return value.toZonedDateTime({
          timeZone: timezone,
          plainTime: Temporal.PlainTime.from(endOfDay ? "23:59:59" : "00:00")
        }).toInstant().toString();
      }
    } catch (_error) {
    }
  ...
  function ensureWrapper(element) {
    element.classList.add("sx-host");
    return element;
  }
  function normalizeEvents(events, timezone, { editable = false } = {}) {
    const calendars = {};
    const scheduleEvents = [];
    (events || []).forEach((event, index) => {
      const isAllDay = Boolean(event.all_day);
      const start = isAllDay ? toTemporalAllDayDate(event.start) : toTemporalDateTime(event.start, timezone);
      let end = isAllDay ? toTemporalAllDayDate(event.end || event.start, -1) : toTemporalDateTime(event.end, timezone);
      if (isAllDay && start && (!end || Temporal.PlainDate.compare(end, start) < 0)) {
        end = start;
      }
      if (!start || !end) return;
      const calendarId = event.calendarId || event.source_subscription_id || event.source_timeline_id || event.id || `calendar-${index}`;
      if (!calendars[calendarId]) {
        calendars[calendarId] = buildCalendarPalette(
          event.timeline_color || event.source_color || "",
          event.source_title || event.title || `Calendar ${index + 1}`,
          !editable
        );
      }
      const palette = calendars[calendarId];
      scheduleEvents.push({
        ...
        timeline_color: event.timeline_color || "",
        editable: event.editable !== false,
        all_day: isAllDay,
        _customContent: {
          monthGrid: eventMarkup(event, palette, timezone, "month"),
          dateGrid: eventMarkup(event, palette, timezone, "detail"),
          timeGrid: eventMarkup(event, palette, timezone, "detail")
        },
        _options: {
          disableDND: true,
          disableResize: true,
          additionalClasses: ["tg-sx-event-shell"]
        }
      });
    });
    return { calendars, scheduleEvents };
  }
  function toHourDraft(date, timezone) {
    return date.toZonedDateTime ? date : date.toZonedDateTime({
      timeZone: timezone,
  ...
  function toEventDetail(event, timezone) {
    const isAllDay = Boolean(event?.all_day);
    const start = toEventDetailValue(event?.start, timezone, { endOfDay: false });
    const end = toEventDetailValue(event?.end, timezone, { endOfDay: isAllDay });
    return {
      id: event?.id || "",
      title: event?.title || "Untitled event",
      start,
  ...
  function formatModalDateRange(event, timezone) {
    const start = event?.start;
    const end = event?.end;
    if (!start || !end) return "";
    if (event?.all_day && isPlainDateValue(start) && isPlainDateValue(end)) {
      ...
      const startDate = new Date(`${start.toString()}T12:00:00`);
      const endDate = new Date(`${end.toString()}T12:00:00`);
      const sameDay = start.toString() === end.toString();
      if (sameDay) return `${dateFormatter.format(startDate)} · All day`;
    ...
    if (sameDay) return `${dateFormatter.format(startDate)} · ${timeFormatter.format(startDate)} – ${timeFormatter.format(endDate)}`;
  ...
  function createEventModalPlugin(config2, timezone) {
    ...
    const ComponentFn = ({ $app }) => {
      ...
      const rect = calendarEventDOMRect.value;
      if (!event || !rect) return null;
      const detail = toEventDetail(event, timezone);
      const viewportWidth = window.innerWidth || 1280;
      const modalWidth = Math.min(400, viewportWidth - 24);
      const left = Math.max(12, Math.min(rect.left, viewportWidth - modalWidth - 12));
      const top = rect.bottom + 12;
      const color = event.calendarId && $app?.config?.calendars?.value?.[event.calendarId]?.lightColors?.main ? $app.config.calendars.value[event.calendarId].lightColors.main : "#6750a4";
      return k2(
        "div",
        {
          className: "sx__event-modal is-open",
          style: {
            "--sx-event-modal-top": `${top}px`,
            "--sx-event-modal-left": `${left}px`,
            "--sx-event-modal-animation-start": "12px"
          },
          tabIndex: 0
        },
        k2(
          "div",
          { className: "sx__event-modal-default" },
          k2(
            "div",
            { className: "sx__has-icon" },
            k2("span", {
              className: "sx__event-modal__color-icon",
              style: { backgroundColor: color }
            }),
            k2("div", null, [
              k2("div", { className: "sx__event-modal__title" }, detail.title),
              k2("div", { className: "sx__event-modal__time" }, formatModalDateRange(event, timezone))
            ])
          ),
          detail.location ? k2("div", { className: "sx__has-icon" }, [k2("span", { className: "sx__event-icon" }, "\u25E6"), k2("div", null, detail.location)]) : null,
          detail.description ? k2("div", { className: "sx__has-icon" }, [k2("span", { className: "sx__event-icon" }, "\u25E6"), k2("div", null, detail.description)]) : null,
          detail.url ? k2("div", { className: "sx__has-icon" }, [k2("span", { className: "sx__event-icon" }, "\u25E6"), k2("a", { href: detail.url, target: "_blank", rel: "noreferrer" }, detail.url)]) : null,
          k2(
            "div",
            { className: "modal-actions", style: { marginTop: "12px" } },
            config2?.onEditEvent && detail.editable !== false ? k2("button", { className: "primary", onClick: () => {
              config2.onEditEvent(detail);
              close();
            } }, "Edit") : null,
            k2("button", { onClick: () => close() }, "Close")
          )
        )
      );
    };
  ...
  function inferLegacyView(range) {
    if (!range?.start || !range?.end) return "dayGridMonth";
    const durationDays = Math.round((range.end.epochMilliseconds - range.start.epochMilliseconds) / 864e5);
    if (durationDays <= 2) return "timeGridDay";
    if (durationDays <= 8) return "timeGridWeek";
    return "dayGridMonth";
  }
  function destroy(element) {
    if (!element) return;
    const calendar = mountedCalendars.get(element);
    if (!calendar) return;
    calendar.destroy();
    mountedCalendars.delete(element);
    element.innerHTML = "";
  }
  function createSharedCalendar(element, config2 = {}, options = {}) {
    if (!element) return null;
    const host = ensureWrapper(element);
    destroy(host);
    host.innerHTML = "";
    const timezone = config2.timezone || Intl.DateTimeFormat().resolvedOptions().timeZone || "UTC";
    const { calendars, scheduleEvents } = normalizeEvents(config2.events || [], timezone, options);
    const viewMonth = createViewMonthGrid();
    const viewWeek2 = createViewWeek();
    const viewDay2 = createViewDay();
    const useNativeEventModal = config2.useNativeEventModal !== false;
    const eventModalPlugin = useNativeEventModal ? createEventModalPlugin(config2, timezone) : null;
    const fallbackFocus = window.TimeGridCalendarDomain?.findCalendarFocus?.(config2.events || []) || null;
    const defaultView = scheduleXViewByLegacy[config2.initialView || fallbackFocus?.legacyView] || (options.editable ? viewWeek2.name : viewMonth.name);
    const mountPoint = document.createElement("div");
    mountPoint.className = "tg-sx-calendar-root";
    host.appendChild(mountPoint);
    const plugins = eventModalPlugin ? [eventModalPlugin] : [];
    const calendar = createCalendar({
      views: [viewMonth, viewWeek2, viewDay2],
      defaultView,
      selectedDate: toPlainDate(config2.selectedDate || fallbackFocus?.selectedDate),
      ...
      callbacks: {
        isCalendarSmall() {
          ...
          return width > 0 ? width < 520 : false;
        },
        onRangeUpdate(range) {
          if (typeof config2.onRangeUpdate === "function") {
            config2.onRangeUpdate({
              range,
              startIso: new Date(range.start.epochMilliseconds).toISOString(),
              endIso: new Date(range.end.epochMilliseconds).toISOString(),
              legacyView: inferLegacyView(range)
            });
          }
        },
        onSelectedDateUpdate(date) {
          if (typeof config2.onSelectedDateUpdate === "function") config2.onSelectedDateUpdate(date);
        },
        onEventClick(event) {
          if (typeof config2.onEventClick === "function") config2.onEventClick(toEventDetail(event, timezone));
        },
        onDoubleClickDate(date) {
          if (typeof config2.onDoubleClickDate === "function") {
            const start = toHourDraft(date, timezone);
            const end = start.add({ hours: 1 });
            config2.onDoubleClickDate({
        ...
        onDoubleClickDateTime(dateTime) {
          if (typeof config2.onDoubleClickDateTime === "function") {
            config2.onDoubleClickDateTime({
              startIso: toIsoString(dateTime),
              endIso: toIsoString(dateTime.add({ hours: 1 }))
            });
          }
        }
      }
    }, plugins);
    calendar.render(mountPoint);
    mountedCalendars.set(host, calendar);
    return calendar;
  }
  function mountReadonly(element, config2 = {}) {
    return createSharedCalendar(element, config2, { editable: false });
  }
  function mountEditor(element, config2 = {}) {
    return createSharedCalendar(element, config2, { editable: true });
  }
  return __toCommonJS(readonly_exports);
})();
